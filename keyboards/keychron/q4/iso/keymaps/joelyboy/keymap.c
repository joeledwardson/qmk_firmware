...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN3] = LAYOUT_iso_62(
        ...
        _______,           KC_HOME,  KC_UP,   KC_END,  _______, _______, _______, _______, KC_INS,  _______, KC_PSCR,  _______,  _______,
        _______,           KC_LEFT,  KC_DOWN, KC_RIGHT,_______,  _______,_______, KC_PGDN, KC_PGUP, _______, _______,  _______,  _______,  _______,

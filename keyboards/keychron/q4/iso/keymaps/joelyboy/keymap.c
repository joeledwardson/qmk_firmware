...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN3] = LAYOUT_iso_62(
        ...
        _______,           _______,  _______, _______, _______, _______, _______, KC_PGUP, KC_INS,  _______, KC_PSCR,  _______,  _______,
        _______,           KC_HOME,  _______, KC_PGDN, _______, KC_END,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______,  _______,  _______,  _______,
